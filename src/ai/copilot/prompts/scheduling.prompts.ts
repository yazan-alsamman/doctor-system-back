...
export const schedulingPrompts = {
  /**
   * Used when the user asks to LIST or COUNT existing appointments
   * (e.g. "كم موعد اليوم؟", "اعرض مواعيد الأسبوع").
   * Data comes from searchAppointments tool — just format it clearly.
   */
  appointmentLister: {
